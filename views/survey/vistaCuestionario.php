<?php foreach ($preguntasEnPagina as $indice => $pregunta): ?>
    ...
    <div class="card-body p-4">
        ...
        switch ($pregunta['tipo']) {
            case 'radio':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/radio.php';
                break;
            case 'checkbox':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/checkbox.php';
                break;
            case 'numberInput':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/numberInput.php';
                break;
            case 'formSelect':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/formSelect.php';
                break;
            case 'matrix1':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/matrix1.php';
                break;
            case 'matrix2':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/matrix2.php';
                break;
            case 'matrix3':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/matrix3.php';
                break;
            case 'matrixPersonalizada':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/matrixPersonalizada.php';
                break;
            case 'matrixPregunta':
                include $_SERVER['DOCUMENT_ROOT'] . '/version2.0/views/survey/tipo_de_pregunta/matrixPregunta.php';
                break;
            default:
